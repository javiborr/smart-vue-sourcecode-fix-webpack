    ...
    */
    propertyChangedHandler(propertyName, oldValue, newValue) {
        ...
        if (propertyName === 'hidden') {
            ...
            else if (that.readonly || that.disabled ||
                ['oneOrManyExtended', 'zeroOrMany', 'oneOrMany', 'checkBox'].indexOf(that.getListBox().selectionMode) === -1) {
    ...
    get _scrollWidth() {
        ...
        that.__scrollWidth = (() => {
            ...
            function measure(labelToMeasure) {
                ...
                const result = (measureItem.$.itemContainer || measureItem).offsetWidth + padding;
